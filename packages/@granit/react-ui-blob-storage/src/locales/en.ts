...
export const blobStorageTranslationsEn = {
  ...
  'BlobStorage.Upload.ChooseFile': 'Choose file',
  'BlobStorage.Upload.FileSelected': 'File selected',
  'BlobStorage.Upload.RemoveFile': 'Remove file',
  'BlobStorage.Upload.Uploading': 'Uploading…',
  'BlobStorage.Upload.UploadProgress': 'Upload progress',
  'BlobStorage.Upload.TooLarge': 'File exceeds {{size}} MB',
  'BlobStorage.Upload.MaxSize': 'Max {{size}} MB',
  'BlobStorage.Upload.UploadImage': 'Upload',
  'BlobStorage.Upload.ReplaceImage': 'Replace',
  'BlobStorage.Upload.RemoveImage': 'Remove image',
  'BlobStorage.Upload.ImagePreview': 'Image preview',
  'BlobStorage.Upload.NoImage': 'No image selected',
} as const;
