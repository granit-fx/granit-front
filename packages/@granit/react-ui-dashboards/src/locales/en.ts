...
export const dashboardsTranslationsEn = {
  ...
  'Dashboards.Edit.IncompleteWidgets_one': '{{count}} widget needs required fields',
  'Dashboards.Edit.IncompleteWidgets_other': '{{count}} widgets need required fields',
  'Dashboards.Edit.MissingRequired': 'Required:',
