...
const mockDefinitions = [
  { name: 'Admin.CountryExport', entityType: 'Country', supportedFormats: ['csv', 'xlsx'] },
  { name: 'Admin.UserExport', entityType: 'IdentityUser', supportedFormats: ['csv', 'xlsx'] },
  { name: 'Admin.AuditingExport', entityType: 'AuditEntry', supportedFormats: ['csv'] },
  { name: 'Admin.TemplateExport', entityType: 'Template', supportedFormats: ['csv', 'xlsx'] },
  {
