...
export const mockHostnames: ManagedHostnameResponse[] = [
  ...
  },
  {
    ...
    verificationToken: null,
    expectedDnsRecords: [],
    lastCheckedAt: toISODateString('2026-06-01T08:05:00Z'),
    conflicts: [],
    failedCheckCount: 0,
    nextCheckAt: toISODateString('2026-06-02T08:05:00Z'),
    certificateStatus: C.Secured,
    certExpiresAt: toISODateString('2027-06-01T08:00:00Z'),
    createdAt: toISODateString('2026-01-05T00:00:00Z'),
    createdBy: 'admin@acme.com',
    modifiedAt: toISODateString('2026-06-01T08:05:00Z'),
    modifiedBy: 'admin@acme.com',
  ...
  },
  {
    ...
    conflicts: [],
    failedCheckCount: 0,
    nextCheckAt: toISODateString('2026-06-02T12:00:00Z'),
    certificateStatus: C.Unprovisioned,
    certExpiresAt: null,
    createdAt: toISODateString('2026-06-01T12:00:00Z'),
