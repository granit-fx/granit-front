...
import { templatesTranslationsEn } from '../locales';

import type { ReactElement, ReactNode } from 'react';

// ---------------------------------------------------------------------------
// Local render helper for the templating admin UI. Page/component tests stub the
// data layer (vi.mock('@granit/react-templating', …), the query engine and the
// data-exchange packages), so only i18n (the package's own flat Templates.*
// bundle plus the few host-owned Common.* / DataExchange.* keys the pages
