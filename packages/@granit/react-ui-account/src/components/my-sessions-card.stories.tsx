...
const meta: Meta<typeof MySessionsCard> = {
  title: 'Account/MySessionsCard',
  component: MySessionsCard,
  tags: ['autodocs'],
...
/** The caller's own active sessions, served by the self-service `/sessions` endpoint. */
