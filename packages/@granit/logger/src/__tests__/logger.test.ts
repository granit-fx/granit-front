...
describe('createLogger', () => {
  ...
  it('should return an object with all log methods and child', () => {
  ...
  it('should include the prefix in debug output', () => {
  ...
  it('should include the prefix in info output', () => {
    const logger = createLogger('[Auth]');
  ...
  it('should include the prefix in warn output', () => {
  ...
  it('should include the prefix in error output', () => {
    const logger = createLogger('[MyApp]');
  ...
  it('should not pass extra args in debug when context is omitted', () => {
    const logger = createLogger('[Test]');
  ...
  it('should pass context in debug when provided', () => {
    const logger = createLogger('[Test]');
  ...
  it('should pass context in info when provided', () => {
    const logger = createLogger('[Test]');
  ...
  it('should pass context in warn when provided', () => {
    const logger = createLogger('[MyApp]');
  ...
  it('should pass error and context in error when provided', () => {
    const logger = createLogger('[Test]');
  ...
  it('should pass only error in error when context is omitted', () => {
    const logger = createLogger('[Test]');
  ...
  it('should produce independent loggers for different prefixes', () => {
...
describe('createLogger with level option', () => {
  it('should suppress debug, info, and warn at level ERROR', () => {
...
describe('createLogger with custom transports', () => {
  it('should dispatch to a custom transport', () => {
    const transport = createMockTransport();
  ...
  it('should include error in LogEntry for error level', () => {
    const transport = createMockTransport();
    const logger = createLogger('[App]', { transports: [transport] });
...
describe('default level', () => {
  it('should default to DEBUG in dev mode (Vitest runs as DEV)', () => {
