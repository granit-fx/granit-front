...
| @commitlint/cli                 | 21.0.1   | commitlint Contributors                    |
...
| @tanstack/react-virtual         | 3.13.25  | Copyright (c) Tanner Linsley               |
...
| @vitest/coverage-v8             | 4.1.7    | Vitest Contributors                        |
| axios                           | 1.16.1   | Copyright (c) Matt Zabriskie               |
| clsx                            | 2.1.1    | Copyright (c) Luke Edwards                 |
| date-fns                        | 4.2.1    | Copyright (c) Sasha Koss                   |
| echarts-for-react               | 3.0.6    | Copyright (c) hustcc                       |
| eslint                          | 10.4.0   | OpenJS Foundation                          |
| eslint-plugin-import-x          | 4.16.2   | eslint-plugin-import-x Contributors        |
| husky                           | 9.1.7    | Copyright (c) typicode                     |
| i18next                         | 26.2.0   | Copyright (c) i18next Contributors         |
| jsdom                           | 29.1.1   | Copyright (c) jsdom Contributors           |
| lint-staged                     | 17.0.5   | Copyright (c) Andrey Okonetchnikov         |
| lucide-react                    | 1.16.0   | Copyright (c) Lucide Contributors          |
...
| react-hook-form                 | 7.76.0   | Copyright (c) react-hook-form Contributors |
...
| typescript-eslint               | 8.59.4   | typescript-eslint Contributors             |
| vite                            | 8.0.14   | Copyright (c) Evan You                     |
| amazon-cognito-identity-js      | 6.3.16   | Copyright (c) Amazon.com, Inc.             |
| vitest                          | 4.1.7    | Vitest Contributors                        |
