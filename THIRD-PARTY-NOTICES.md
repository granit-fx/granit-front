...
| @commitlint/cli                 | 21.2.0  | commitlint Contributors                    |
...
| @puckeditor/core                | 0.22.0  | Copyright (c) Measured Corp                |
...
| @types/node                     | 26.1.0  | DefinitelyTyped Contributors               |
...
| eslint                          | 10.6.0  | OpenJS Foundation                          |
| eslint-plugin-import-x          | 4.17.1  | eslint-plugin-import-x Contributors        |
| husky                           | 9.1.7   | Copyright (c) typicode                     |
| i18next                         | 26.3.4  | Copyright (c) i18next Contributors         |
| isomorphic-dompurify            | 3.x     | Copyright (c) Andrew Karpów                |
| jsdom                           | 29.1.1  | Copyright (c) jsdom Contributors           |
| lint-staged                     | 17.0.8  | Copyright (c) Andrey Okonetchnikov         |
| lucide-react                    | 1.23.0  | Copyright (c) Lucide Contributors          |
| markdownlint-cli2               | 0.23.0  | Copyright (c) David Anson                  |
| marked                          | 18.0.5  | Copyright (c) 2018+ MarkedJS contributors  |
| msw                             | 2.14.6  | Copyright (c) Artem Zakharchenko           |
| prettier                        | 3.9.4   | Copyright (c) James Long                   |
...
| typescript-eslint               | 8.62.1  | typescript-eslint Contributors             |
| vanilla-cookieconsent           | 3.1.0   | Copyright (c) Orest Bida                   |
| vite                            | 8.1.3   | Copyright (c) Evan You                     |
| amazon-cognito-identity-js      | 6.3.18  | Copyright (c) Amazon.com, Inc.             |
...
| @opentelemetry/context-zone                     | 2.9.0   | Copyright The OpenTelemetry Authors |
| @opentelemetry/exporter-trace-otlp-http         | 0.220.0 | Copyright The OpenTelemetry Authors |
| @opentelemetry/instrumentation                  | 0.220.0 | Copyright The OpenTelemetry Authors |
| @opentelemetry/instrumentation-document-load    | 0.65.0  | Copyright The OpenTelemetry Authors |
| @opentelemetry/instrumentation-fetch            | 0.220.0 | Copyright The OpenTelemetry Authors |
| @opentelemetry/instrumentation-xml-http-request | 0.220.0 | Copyright The OpenTelemetry Authors |
| @opentelemetry/resources                        | 2.9.0   | Copyright The OpenTelemetry Authors |
| @opentelemetry/sdk-trace-web                    | 2.9.0   | Copyright The OpenTelemetry Authors |
